...
$html_to_print = '<!DOCTYPE html><html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en"><head><meta charset="UTF-8"/><meta name="viewport" content="width=device-width,initial-scale=1.0"/><title>Lyrics of Beethoven\'s Ode to Joy - Lyrics repository</title><link rel="stylesheet" type="text/css" href="'.$path_parts['dirname'].'/base.php"/>'.
				...
				'<ul><li><a href="#">Other lyrics from this artist</a></li><li><a href="'.$path_parts['dirname'].'/beethoven_mobile.php">Beethoven\'s Ode to Joy</a></li><li><a href="#">Other lyrics from this period</a></li><li><a href="#">Contact Us</a></li><li><a href="#">Copyright and licenses</a></li><li><a href="#">Privacy policy</a></li><li>'.
				'<a href="'.$path_parts['dirname'].'/beethovenlife.php?vpa=d">Visit desktop version of this website</a>'.
