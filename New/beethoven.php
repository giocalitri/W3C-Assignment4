...
<head>
	...
	<title>Lyrics of Beethoven's Ode to Joy - Lyrics repository</title>
	<link rel="stylesheet" type="text/css" href="base.css" />
	<?php
	if ($is_mobile == 0)
	{
		echo '<link rel="stylesheet" type="text/css" href="enhanced_600_800.css" />
		<link rel="stylesheet" type="text/css" href="enhanced_800_plus.css" media="only all and (min-width: 801px)" />
		<!--[if lt IE 9 & !IEMobile]>
			<link rel="stylesheet" type="text/css" href="enhanced_600_800.css" />
		<![endif]-->';
	}
	?>
</head>
<body>
	<div id="header">
		<h1>Lyrics of Beethoven's Ode to Joy</h1>
	</div>
	<div id="container">
		<div id="sidebar1" class="sidebar">
			<ul>
				<li><a href="#">Lyric Repository's Home</a></li>
				<li><a href="#">Site Map</a></li>	
			</ul>
		</div>
		<div id="breadcrumbs" class="breadcrumbs">
			Home -&gt; Beethoven's Ode to Joy
		</div>
		<div id="centralpart">
			...
			<div id="content2" class="content">
				...
				<dl class="symphonies-list">
					<dt><img width="15" height="15" alt="[Music Symbol]" src="music.gif" /> Symphony 1</dt>
					<dd>Op. 21</dd>
					<dd>Tone: C Major</dd>
					<dd>Year: 1800</dd>
					
					<dt><img width="15" height="15" alt="[Music Symbol]" src="music.gif" /> Symphony 2</dt>
					<dd>Op. 36</dd>
					<dd>Tone: D Major</dd>
					<dd>Year: 1802</dd>
					
					<dt><img width="15" height="15" alt="[Music Symbol]" src="music.gif" /> Symphony 3, "Eroica"</dt>
					<dd>Op. 55</dd>
					<dd>Tone: E flat Major</dd>
					<dd>Year: 1804</dd>
					
					<dt><img width="15" height="15" alt="[Music Symbol]" src="music.gif" /> Symphony 4</dt>
					<dd>Op. 60</dd>
					<dd>Tone: B flat Major</dd>
					<dd>Year: 1806</dd>
					
					<dt><img width="15" height="15" alt="[Music Symbol]" src="music.gif" /> Symphony 5</dt>
					<dd>Op. 67</dd>
					<dd>Tone: C Minor</dd>
					<dd>Year: 1808</dd>
					
					<dt><img width="15" height="15" alt="[Music Symbol]" src="music.gif" /> Symphony 6, "Pastorale"</dt>
					<dd>Op. 68</dd>
					<dd>Tone: F Major</dd>
					<dd>Year: 1808</dd>
					
					<dt><img width="15" height="15" alt="[Music Symbol]" src="music.gif" /> Symphony 7</dt>
					<dd>Op. 92</dd>
					<dd>Tone: A Major</dd>
					<dd>Year: 1812</dd>
					
					<dt><img width="15" height="15" alt="[Music Symbol]" src="music.gif" /> Symphony 8</dt>
					<dd>Op. 93</dd>
					<dd>Tone: F Major</dd>
					<dd>Year: 1813</dd>
					
					<dt><img width="15" height="15" alt="[Music Symbol]" src="music.gif" /> Symphony 9</dt>
					<dd>Op. 125</dd>
					<dd>Tone: D Minor</dd>
					<dd>Year: 1824</dd>
				</dl>
		...
		<div id="sidebar2" class="sidebar">
			<ul>
				<li><a href="#">Other lyrics from this artist</a></li>
				<li><a href="#">More information on this artist</a></li>
				<li><a href="#">Other lyrics from this period</a></li>
				<li><a href="#">Contact Us</a></li>
				<li><a href="#">Copyright and licenses</a></li>
				<li><a href="#">Privacy policy</a></li>
			</ul>
		</div>
	</div>
	<div id="footer">
		<p>This page was built for demonstration purposes.</p>
	</div>
</body>
</html>