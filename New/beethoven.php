...
$html_to_print .= '<p>Beethoven\'s last symphony includes part of the <cite>Ode to Joy</cite> poem\'s written by Friedrich Schiller.</p>'.
				...
				'<ul><li><a href="#">Other lyrics from this artist</a></li><li><a href="#">More information on this artist</a></li><li><a href="#">Other lyrics from this period</a></li><li><a href="#">Contact Us</a></li><li><a href="#">Copyright and licenses</a></li><li><a href="#">Privacy policy</a></li><li>';
if($is_mobile == 0) 
{
